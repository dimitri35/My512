...
public class BoardImplTest {
    ...
    public void testPackIntoDirection2() throws Exception {
        ...
        testBoard.commit();
        Tile uniqueTile = testBoard.getTile(1, 1);
        Assert.assertNotEquals(uniqueTile,Tile.NONDEFINI);//assertNotNull
        Assert.assertEquals(1, uniqueTile.getRank());
        Assert.assertEquals(testBoard.getTile(1, 3),Tile.NONDEFINI);//assertNull
    }
    ...
    */
    ...
    public void testPackIntoDirection4() throws Exception {
        ...
        testBoard.packIntoDirection(Board.Direction.LEFT);
        testBoard.commit();
        Assert.assertNotEquals(testBoard.getTile(1, 1),Tile.NONDEFINI);//assertNotNull
        Assert.assertEquals(2, testBoard.getTile(1, 1).getRank());
        Assert.assertEquals(testBoard.getTile(1, 2),Tile.NONDEFINI);//assertNull
        Assert.assertEquals(testBoard.getTile(1, 3),Tile.NONDEFINI);//assertNull
    }
    ...
    public void testPackIntoDirection5() throws Exception {
        ...
        Assert.assertNotEquals(testBoard.getTile(1, 2),Tile.NONDEFINI);//assertNotNull
        Assert.assertEquals(2, testBoard.getTile(1, 2).getRank());
        Assert.assertEquals(testBoard.getTile(1, 3),Tile.NONDEFINI);//assertNull
    }
    ...
    public void testPackIntoDirection10() throws Exception {
        ...
        testBoard.commit();
        Assert.assertEquals(testBoard.getTile(1, 1),Tile.NONDEFINI);//assertNull
        Assert.assertNotEquals(testBoard.getTile(1, 2), Tile.NONDEFINI);//assertNotNull
        Assert.assertEquals(3, testBoard.getTile(1, 2).getRank());
        Assert.assertNotEquals(testBoard.getTile(1, 3),Tile.NONDEFINI);//assertNotNull
    ...
    public void testPackIntoDirection30() throws Exception {
        ...
        testBoard.commit();
        Assert.assertNotEquals(testBoard.getTile(3, 1),Tile.NONDEFINI);//assertNotNull
        Assert.assertEquals(1, testBoard.getTile(3, 1).getRank());
        Assert.assertNotEquals(testBoard.getTile(3, 2),Tile.NONDEFINI);//assertNotNull
        Assert.assertEquals(2, testBoard.getTile(3, 2).getRank());
        Assert.assertNotEquals(testBoard.getTile(3, 3),Tile.NONDEFINI);//assertNotNull
